  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <input type="file" accept=".layout" multiple onChange={handleFileChange} style={styles.fileInput} />
        ...
        {uploadComplete && (
          <div style={{ marginTop: "20px" }}>
            {loading ? (
              ...
              <button style={{ ...styles.button, backgroundColor: "#28a745" }} onClick={handleStart} disabled={loading}>
                수납정산 시작
              </button>
            )}
          </div>
